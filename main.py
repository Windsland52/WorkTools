...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        self.colour_schemes = [{"bg": "lightgray", "fg": "black"}, {"bg": "gray", "fg": "white"}]
    ...
    def set_task_colour(self, postion, task):
        _, task_style_choice = divmod(postion, 2)
